...
class addTasks(forms.Form):
    t_i_n = forms.CharField(label='ИНН', required=True, widget=forms.TextInput(attrs={
        'class': 'form-control',
        'placeholder': 'ИНН',
        'id': "floatingInputGrid",
    }))

    provider = forms.CharField(label='Поставщик', required=True, widget=forms.TextInput(attrs={
        'class': 'form-control',
        'placeholder': 'Поставщик',
        'id': "floatingInputGrid",
    }))

    full_name = forms.CharField(label='ФИО Поставщика', required=True, widget=forms.TextInput(attrs={
        'class': 'form-control',
        'placeholder': 'ФИО Поставщика',
        'id': "floatingInputGrid",
    }))

    ogrnip = forms.CharField(label='ОГРНИП', required=True, widget=forms.TextInput(attrs={
        'class': 'form-control',
        'placeholder': 'ОГРНИП',
        'id': "floatingInputGrid",
    }))
